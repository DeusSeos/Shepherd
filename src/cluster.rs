...
use rancher_client::apis::{ResponseContent, Error, configuration::Configuration};

use rancher_client::{
    apis::management_cattle_io_v3_api::{list_management_cattle_io_v3_clusters, ListManagementCattleIoV3ClustersError}, 
    models::IoCattleManagementv3ClusterList,
    models::IoCattleManagementv3Cluster
};
